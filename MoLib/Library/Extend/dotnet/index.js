...
exports.hash = (function(){
	...
	$hash.compute = function(provider,src,key){
		...
		var bte = exports.encoding.utf8.getBytes(src);
		if(typeof key=="string") _provider.Key = exports.encoding.utf8.getBytes(key);
		var result = _provider.ComputeHash_2(bte);
		_provider.Dispose();
		return Encoding.hex.stringify(base64.d(base64.fromBinary(result)));
	};
	var $md5 = $hash.md5={};
